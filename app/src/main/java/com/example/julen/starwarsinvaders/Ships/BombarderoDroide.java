...
public class BombarderoDroide {
    ...
    public BombarderoDroide(Context context, int row, int column, int screenX, int screenY) {
        ...
        int padding = screenX / 7;

        x = column * (length + padding);
        y = row * (length + padding/4);

        // Inicializa el bitmap
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.bombardero_droide);
