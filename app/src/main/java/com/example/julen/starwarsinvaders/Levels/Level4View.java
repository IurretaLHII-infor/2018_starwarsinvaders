...
import com.example.julen.starwarsinvaders.Ships.BombarderoDroide2;
...
public class Level4View extends LevelView {
    ...
    BombarderoDroide2[] bombarderoEnemigo = new BombarderoDroide2[7];
    ...
    public static boolean playerStop = false;
    ...
    public Level4View(Context context, int x, int y, Sensor azelerometroa, SensorManager sm, final String mugimenduAukera, String partidaMota, int score, int lives, StarWarsActivity starWarsActivity) {
    ...
    private void prepareLevel() {
        ...
        for (int column = 0; column < 7; column++) {
            for (int row = 0; row < 1; row++) {
                bombarderoEnemigo[numBombarderoEnemigo] = new BombarderoDroide2(context, row, column, screenX, screenY);
    ...
    private void update() {
        ...
        if (cazaDestruida == 32 && bombarderoDestruido == 7) {
            Irabazi();
        }
    ...
    private void draw() {
        ...
        if (ourHolder.getSurface().isValid()) {
            ...
            if (fondoAtrezo.getVisibility()) {
                canvas.drawBitmap(fondoAtrezo.getBitmap6(), fondoAtrezo.getX(), fondoAtrezo.getY(), paint);
            }
