...
public class CazaDroide {
    ...
    public CazaDroide(Context context, int row, int column, int screenX, int screenY) {
        ...
        bitmap1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.caza_droide);
